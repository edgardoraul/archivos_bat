...
mysqli_query( $con, "UPDATE ps_product, importacion_precios SET `ps_product`.`active` = 0 WHERE `ps_stock_available`.`id_product_attribute` = 0 ");
mysqli_query( $con, "UPDATE ps_product_shop, ps_product SET `ps_product_shop`.`active` = 0 WHERE `ps_product_attribute`.`reference` = 0 ");



// Activa los productos con stock superior a cero.
mysqli_query( $con, "UPDATE ps_product, importacion_precios SET `ps_product`.`active` = 1 WHERE  `ps_stock_available`.`id_product_attribute` = 0 ");
mysqli_query( $con, "UPDATE ps_product_shop, ps_product SET `ps_product_shop`.`active` = 1 WHERE `ps_product_attribute`.`reference` = 0 ");
